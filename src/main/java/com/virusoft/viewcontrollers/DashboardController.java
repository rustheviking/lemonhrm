...
public class DashboardController implements DashboardUpdateListener {
    ...
    private  void loadNavbarFXML(String userRole) throws IOException {
        ...
        if ("admin".equals(userRole)){
            FXMLPath = "/com/virusoft/views/admin-user-navbar-view.fxml";
            ...
            FXMLPath = "/com/virusoft/views/pim-user-navbar-view.fxml";
            FXMLLoader loader = new FXMLLoader(getClass().getResource(FXMLPath));
            Parent navbar = loader.load();
    ...
    private  void loadContentMenuFXML() throws IOException {
        String FXMLPath = "/com/virusoft/views/dashboard-menu-view.fxml";
        FXMLLoader loader = new FXMLLoader(getClass().getResource(FXMLPath));
    ...
    private  void loadContentFXML() throws IOException {
        String FXMLPath = "/com/virusoft/views/dashboard-content-view.fxml";
        FXMLLoader loader = new FXMLLoader(getClass().getResource(FXMLPath));
    ...
    public void onAdminButtonClicked() {
        ...
        try {
            //Set up admin menu
            String menuFXMLPath = "/com/virusoft/views/admin-menu-view.fxml";
            ...
            String contentFXMLPath = "/com/virusoft/views/users-content-view.fxml";
    ...
    public void onPimButtonClicked() {
        ...
        try {
            String FXMLPath = "/com/virusoft/views/pim-menu-view.fxml";
            FXMLLoader loader = new FXMLLoader(getClass().getResource(FXMLPath));
            ...
            String contentFXMLPath = "/com/virusoft/views/pim-content-view.fxml";
            FXMLLoader contentLoader = new FXMLLoader(getClass().getResource(contentFXMLPath));
